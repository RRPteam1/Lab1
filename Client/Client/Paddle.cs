...
namespace Pong
{
    ...
    public class Paddle
    {
        ...
        {
            sprite = content.Load<Texture2D>("paddle"); // todo
        }
        ...
        public void ClientSideUpdate(GameTime gameTime)
        {
            ...
            float dist = timeDelta * 100; //speed of paddle
        ...
        public void Draw(GameTime gameTime, SpriteBatch spriteBatch, Color color) => spriteBatch.Draw(sprite, Position, color); //!todo!
